...
typedef testing::Types<
    test_types<
        ...
        algebra::vecmem::bound_track_parameters<float>,
        algebra::vecmem::free_track_parameters<float>,
    ...
    test_types<
        ...
        algebra::vecmem::bound_track_parameters<double>,
        algebra::vecmem::free_track_parameters<double>,
