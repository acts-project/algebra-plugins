...
struct index<Fastor::Tensor<T, N>> {
  using type = std::size_t;
};
/// @}
...
template <typename T, std::size_t N>
struct dimensions<Fastor::Tensor<T, N>> {
...
template <typename T, std::size_t N>
struct value<Fastor::Tensor<T, N>> {
  using type = T;
};
/// @}
...
struct vector<Fastor::Tensor<T, ROWS, COLS>> {
  ...
  using other_type = Fastor::Tensor<other_T, other_N>;
...
template <typename T, std::size_t ROWS, std::size_t COLS>
struct matrix<algebra::fastor::Matrix<T, ROWS, COLS>> {
  template <typename other_T, std::size_t other_ROWS, std::size_t other_COLS>
  using other_type = algebra::fastor::Matrix<other_T, other_ROWS, other_COLS>;

  using type = algebra::fastor::Matrix<T, ROWS, COLS>;
};
...
template <typename T, std::size_t ROWS, std::size_t COLS>
struct element_getter<algebra::fastor::Matrix<T, ROWS, COLS>> {
  using type = fastor::storage::element_getter;
};
...
template <typename T, std::size_t ROWS, std::size_t COLS>
struct block_getter<algebra::fastor::Matrix<T, ROWS, COLS>> {
  using type = fastor::storage::block_getter;
};

template <typename T, std::size_t N>
struct block_getter<Fastor::Tensor<T, N>> {
  using type = fastor::storage::block_getter;
};
/// @}
