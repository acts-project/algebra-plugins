...
typedef testing::Types<
    test_types<
        ...
        algebra::array::bound_track_parameters<float>,
        algebra::array::free_track_parameters<float>,
    ...
    test_types<
        ...
        algebra::array::bound_track_parameters<double>,
        algebra::array::free_track_parameters<double>,
