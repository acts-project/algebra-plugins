...
struct element_getter {
  ...
  ALGEBRA_HOST_DEVICE inline scalar& operator()(matrix_type& m,
                                                unsigned int row,
  ...
  template <typename matrix_type>
  ALGEBRA_HOST_DEVICE inline scalar operator()(const matrix_type& m,
                                               unsigned int row,
                                               unsigned int col) const {
...
struct block_getter {
  ...
  ALGEBRA_HOST_DEVICE Eigen::Matrix<scalar, kROWS, kCOLS> operator()(
