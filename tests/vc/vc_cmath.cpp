...
typedef testing::Types<
    test_types<
        float, Vc::array<float, 2>, Vc::array<float, 3>, Vc::array<float, 2>,
        Vc::array<float, 3>, algebra::vc::transform3<float>,
        algebra::vc::cartesian2<float>, algebra::vc::cartesian3<float>,
        algebra::vc::polar2<float>, algebra::vc::cylindrical2<float>,
        algebra::vc::cylindrical3<float>, algebra::vc::line2<float>,
        std::size_t, algebra::vc::matrix_type, algebra::vector::actor<float>,
