...
// clang-format off
#define ALGEBRA_REGISTER_CUDA_VECTOR_TESTS(...) \
  REGISTER_TYPED_TEST_SUITE_P(cuda_vector_test \
    , vector_2d_ops \
    , vector_3d_ops \
)

#define ALGEBRA_REGISTER_CUDA_MATRIX_TESTS(...) \
  REGISTER_TYPED_TEST_SUITE_P(cuda_matrix_test \
    , matrix64_ops \
    , matrix22_ops \
    )

#define ALGEBRA_REGISTER_CUDA_TRANSFORM_TESTS(...) \
  REGISTER_TYPED_TEST_SUITE_P(cuda_transform_test \
    , transform3D \
)
// clang-format on
