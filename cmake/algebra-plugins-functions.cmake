...
function(algebra_add_benchmark name)
    ...
    set(ALGEBRA_BENCHMARK_ARCHITECTURE_FLAG
        "-march=native"
        CACHE STRING
    ...
    if(
        ALGEBRA_BENCHMARK_ARCHITECTURE_FLAG_SUPPORTED
        AND (NOT "${CMAKE_CXX_FLAGS}" MATCHES "-march=")
    )
        target_compile_options(
            algebra_benchmark_${name}
            PRIVATE "${ALGEBRA_BENCHMARK_ARCHITECTURE_FLAG}"
        )
    endif()
