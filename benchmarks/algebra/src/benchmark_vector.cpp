...
int main(int argc, char** argv) {
  ...
  std::cout << "-----------------------------------------------\n"
            << "Algebra-Plugins 'vector' benchmark ("
...
//
  ...
  ALGEBRA_PLUGINS_DEFINE_VECTOR_BENCH(array)
#elif ALGEBRA_BENCHMARK_EIGEN
  ALGEBRA_PLUGINS_DEFINE_VECTOR_BENCH(eigen)
#elif ALGEBRA_BENCHMARK_FASTOR
  ALGEBRA_PLUGINS_DEFINE_VECTOR_BENCH(fastor)
#elif ALGEBRA_BENCHMARK_SMATRIX
  ALGEBRA_PLUGINS_DEFINE_VECTOR_BENCH(smatrix)
#elif ALGEBRA_BENCHMARK_VC_AOS
  ALGEBRA_PLUGINS_DEFINE_VECTOR_BENCH(vc_aos)
#endif

  ALGEBRA_PLUGINS_REGISTER_VECTOR_BENCH(cfg, cfg)
