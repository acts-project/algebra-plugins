...
typedef testing::Types<
    test_types<
        ...
        algebra::eigen::line2<float>, int, algebra::eigen::matrix_type,
        algebra::vector::actor, algebra::matrix::actor<float>>,
    test_types<
        ...
        algebra::eigen::line2<double>, int, algebra::eigen::matrix_type,
        algebra::vector::actor, algebra::matrix::actor<double>>>
    eigen_eigen_types;
