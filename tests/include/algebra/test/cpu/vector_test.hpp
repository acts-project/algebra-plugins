...
TYPED_TEST_P(vector_test, vector3D) {
    ...
    static_assert(
        !algebra::concepts::scalar<algebra::get_vector3D_t<TypeParam>>);
    static_assert(
        algebra::concepts::vector<algebra::get_vector3D_t<TypeParam>>);
    static_assert(
    ...
    static_assert(
        !algebra::concepts::scalar<algebra::get_vector2D_t<TypeParam>>);
    static_assert(
        algebra::concepts::vector<algebra::get_vector2D_t<TypeParam>>);
    static_assert(
