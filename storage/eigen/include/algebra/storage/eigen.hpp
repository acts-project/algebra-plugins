...
template <typename T, int ROWS, int COLS, int OPT>
struct index<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {
  using type = algebra::eigen::size_type;
};
...
template <typename T, int ROWS, int COLS, int OPT>
struct dimensions<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {

  using size_type = index_t<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>>;
...
template <typename T, int ROWS, int COLS, int OPT>
struct value<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {
  using type = T;
};
...
template <typename T, int ROWS, int COLS, int OPT>
struct vector<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {
...
template <typename T, int ROWS, int COLS, int OPT>
struct matrix<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {
  template <typename other_T, int other_ROWS, int other_COLS>
  using other_type = eigen::matrix_type<other_T, other_ROWS, other_COLS>;

  using type = Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>;
};
...
template <typename T, int ROWS, int COLS, int OPT>
struct element_getter<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {
  using type = eigen::storage::element_getter;
};
...
template <typename T, int ROWS, int COLS, int OPT>
struct block_getter<Eigen::Matrix<T, ROWS, COLS, OPT, ROWS, COLS>> {
  using type = eigen::storage::block_getter;
};
/// @}
/// @}
