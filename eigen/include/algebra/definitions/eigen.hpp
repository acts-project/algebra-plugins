...
ALGEBRA_HOST_DEVICE inline auto block(const Eigen::MatrixBase<derived_type> &m,
                                      unsigned int row, unsigned int col) {
...
struct transform3 {
  ...
  ALGEBRA_HOST_DEVICE static inline auto rotate(
      const Eigen::Transform<scalar, 3, Eigen::Affine> &m,
  ...
  ALGEBRA_HOST_DEVICE
  inline auto rotation() const { return _data.matrix().block<3, 3>(0, 0); }

  /** This method retrieves the translation of a transform **/
  ALGEBRA_HOST_DEVICE
  inline auto translation() const { return _data.matrix().block<3, 1>(0, 3); }
...
struct cartesian2 {
   ...
   **/
  ALGEBRA_HOST_DEVICE
  inline auto operator()(const transform3 &trf, const point3 &p) const {
...
struct polar2 {
  ...
  ALGEBRA_HOST_DEVICE inline auto operator()(
    ...
    constexpr int rows = Eigen::MatrixBase<derived_type>::RowsAtCompileTime;
    constexpr int cols = Eigen::MatrixBase<derived_type>::ColsAtCompileTime;
    static_assert(rows >= 2 and cols == 1,
                  "transform::point_topoint2pol(v) requires a (>2,1) matrix");
...
struct cylindrical2 {
  ...
  ALGEBRA_HOST_DEVICE inline auto operator()(
    ...
    constexpr int cols = Eigen::MatrixBase<derived_type>::ColsAtCompileTime;
    static_assert(rows == 3 and cols == 1,
                  "transform::point3_topoint2cyl(v) requires a a (3,1) matrix");
