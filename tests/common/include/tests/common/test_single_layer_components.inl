...
TEST(ALGEBRA_PLUGIN, barrel_component_construction)
{
...
TEST(ALGEBRA_PLUGIN, barrel_object_finding)
{
...
// Test the basic barrel components function
TEST(ALGEBRA_PLUGIN, endcap_component_construction)
{
    // Rectangular module parameters
...
TEST(ALGEBRA_PLUGIN, endcap_object_finding)
{
