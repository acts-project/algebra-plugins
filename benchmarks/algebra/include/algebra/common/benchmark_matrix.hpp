...
#define ALGEBRA_PLUGINS_DEFINE_MATRIX_BENCH(PLUGIN)                            \
...
#define ALGEBRA_PLUGINS_REGISTER_MATRIX_BENCH(CFGS, CFGD)               \
    algebra::register_benchmark<mat44_transp_f_t>(CFGS, "_4x4_single"); \
    algebra::register_benchmark<mat44_transp_d_t>(CFGD, "_4x4_double"); \
    algebra::register_benchmark<mat66_transp_f_t>(CFGS, "_6x6_single"); \
    algebra::register_benchmark<mat66_transp_d_t>(CFGD, "_6x6_double"); \
    algebra::register_benchmark<mat88_transp_f_t>(CFGS, "_8x8_single"); \
    algebra::register_benchmark<mat88_transp_d_t>(CFGD, "_8x8_double"); \
                                                                        \
    algebra::register_benchmark<mat44_inv_f_t>(CFGS, "_4x4_single");    \
    algebra::register_benchmark<mat44_inv_d_t>(CFGD, "_4x4_double");    \
    algebra::register_benchmark<mat66_inv_f_t>(CFGS, "_6x6_single");    \
    algebra::register_benchmark<mat66_inv_d_t>(CFGD, "_6x6_double");    \
    algebra::register_benchmark<mat88_inv_f_t>(CFGS, "_8x8_single");    \
    algebra::register_benchmark<mat88_inv_d_t>(CFGD, "_8x8_double");    \
                                                                        \
    algebra::register_benchmark<mat44_det_f_t>(CFGS, "_4x4_single");    \
    algebra::register_benchmark<mat44_det_d_t>(CFGD, "_4x4_double");    \
    algebra::register_benchmark<mat66_det_f_t>(CFGS, "_6x6_single");    \
    algebra::register_benchmark<mat66_det_d_t>(CFGD, "_6x6_double");    \
    algebra::register_benchmark<mat88_det_f_t>(CFGS, "_8x8_single");    \
    algebra::register_benchmark<mat88_det_d_t>(CFGD, "_8x8_double");    \
                                                                        \
    algebra::register_benchmark<mat44_add_f_t>(CFGS, "_4x4_single");    \
    algebra::register_benchmark<mat44_add_d_t>(CFGD, "_4x4_double");    \
    algebra::register_benchmark<mat66_add_f_t>(CFGS, "_6x6_single");    \
    algebra::register_benchmark<mat66_add_d_t>(CFGD, "_6x6_double");    \
    algebra::register_benchmark<mat88_add_f_t>(CFGS, "_8x8_single");    \
    algebra::register_benchmark<mat88_add_d_t>(CFGD, "_8x8_double");    \
                                                                        \
    algebra::register_benchmark<mat44_mul_f_t>(CFGS, "_4x4_single");    \
    algebra::register_benchmark<mat44_mul_d_t>(CFGD, "_4x4_double");    \
    algebra::register_benchmark<mat66_mul_f_t>(CFGS, "_6x6_single");    \
    algebra::register_benchmark<mat66_mul_d_t>(CFGD, "_6x6_double");    \
    algebra::register_benchmark<mat88_mul_f_t>(CFGS, "_8x8_single");    \
    algebra::register_benchmark<mat88_mul_d_t>(CFGD, "_8x8_double");    \
                                                                        \
    algebra::register_benchmark<mat44_vec_f_t>(CFGS, "_4x4_single");    \
    algebra::register_benchmark<mat44_vec_d_t>(CFGD, "_4x4_double");    \
    algebra::register_benchmark<mat66_vec_f_t>(CFGS, "_6x6_single");    \
    algebra::register_benchmark<mat66_vec_d_t>(CFGD, "_6x6_double");    \
    algebra::register_benchmark<mat88_vec_f_t>(CFGS, "_8x8_single");    \
    algebra::register_benchmark<mat88_vec_d_t>(CFGD, "_8x8_double");
