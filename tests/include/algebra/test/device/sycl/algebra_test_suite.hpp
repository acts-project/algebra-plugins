...
#include "matrix_fixture.hpp"
#include "sycl_test_fixture.hpp"
#include "transform_fixture.hpp"
...
TYPED_TEST_P(sycl_transform_test, transform3) {
...
// clang-format off
#define ALGEBRA_REGISTER_SYCL_VECTOR_TESTS(...) \
  REGISTER_TYPED_TEST_SUITE_P(sycl_vector_test \
    , vector_2d_ops \
    , vector_3d_ops \
)

#define ALGEBRA_REGISTER_SYCL_MATRIX_TESTS(...) \
  REGISTER_TYPED_TEST_SUITE_P(sycl_matrix_test \
    , matrix64_ops \
    , matrix22_ops \
)

#define ALGEBRA_REGISTER_SYCL_TRANSFORM_TESTS(...) \
  REGISTER_TYPED_TEST_SUITE_P(sycl_transform_test \
    , transform3D \
)
// clang-format on
